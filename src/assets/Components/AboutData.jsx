    ...
    return (
        <section className="md:max-w-6xl px-6 mx-0 md:mx-auto text-gray-200 py-12 md:py-18">
            ...
            <div className="border-b border-[var(--fade-color)]">
                ...
                <motion.button 
                    className="main-button mb-4 opacity-70"
                    initial={{ opacity: 0, y: 20 }}
            ...
            <div className='flex md:flex-row flex-col gap-10 py-10 relative'>
                ...
                <div className='md:w-1/2 w-full'>
                    ...
                    {experienceData.map((exp, index) => (
                        <motion.div 
                            key={index}
                            className='flex flex-row items-start justify-start p-8 gap-6 mt-6 font-normal border border-[var(--subtext-color)]/20 bg-gradient-to-tr from-(--primary-white)/5 to-(--secondary-color)/20 rounded-lg transform-all duration-300 hover:border-(--primary-color)/50 cursor-pointer'
                            initial={{ opacity: 0, x: -30 }}
                            whileInView={{ opacity: 1, x: 0 }}
                            viewport={{ once: true }}
                ...
                <div className='md:w-1/2 w-full'>
                    ...
                    {educationData.map((edu, index) => (
                        <motion.div 
                            key={index}
                            className='relative flex flex-row items-start justify-start group p-8 gap-6 mt-6 font-normal border border-[var(--subtext-color)]/20 bg-black transition-all duration-300 rounded-lg hover:border-(--primary-color)/50 cursor-pointer'
                            initial={{ opacity: 0, x: 30 }}
                            whileInView={{ opacity: 1, x: 0 }}
                            viewport={{ once: true }}
                            transition={{ duration: 0.6, delay: index * 0.15 }}
