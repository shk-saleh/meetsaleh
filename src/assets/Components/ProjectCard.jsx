...
const ProjectCard = ({id, slug, type, projectName, projectThumb}) => {
  ...
  return (
    <div className='relative bg-gradient-to-b from-(--body-color) to-(--fade-color)/70 border border-(--fade-color) pt-4 ps-4 pe-4 md:p-6 pb-1 rounded-xl cursor-pointer'>
