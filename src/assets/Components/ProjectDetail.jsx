...
const ProjectDetail = () => {
  ...
  return (
      <div className='px-6 md:px-40 py-10 h-full'>
        ...
        <div className='flex justify-between items-center'>
          <div className='flex items-center gap-4'>
            ...
            <div>
              ...
              <h2 className='text-2xl md:text-4xl font-semibold mb-6'>{project.projectName}</h2>
            </div>
          </div>
        ...
        <div className='w-full h:[200px] md:h-[500px] rounded-2xl mt-8 mb-8 overflow-hidden'>
          <img 
